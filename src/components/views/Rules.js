                    ...
                    <div className="rulesRectangle">
                        <div className="rulesText">
                            ...
                            <div className="slider" style={{height: '200px'}}>
                                ...
                                {currentPointRules === 4 && (
                                        <>
                                            As the Clue-giver gives clues, his or her teammates write possible words in the chat trying to guess the Guess Word.
                                            <br />
                                        </>
                                )}
                                {currentPointRules === 5 && (
                                        <>
                                            Each time a teammate types out the correct Guess Word, the Clue-giver's team scores a point. A new card will be drawn. For each correctly guessed word the team receives one point.
                                            <br />
                                        </>
                                )}
                                {currentPointRules === 6 && (
                                ...
                                {currentPointRules === 7 && (
                                        <>
                                            If a TABOO word is used by the Clue-giver or if any of the RULES FOR CLUES are broken, the buzzer will be used by the opposing team.
                                            <br />
                                        </>
                                )}
                                {currentPointRules === 8 && (
                                        <>
                                            If the Clue-giver cannot describe the given word then he or she can use the Skip button to skip the card.
                                            <br />
                                        </>
                                )}
                                {currentPointRules === 9 && (
